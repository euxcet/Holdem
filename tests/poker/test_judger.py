...
from alphaholdem.poker.component.dealer import Dealer
from alphaholdem.poker.component.deck import Deck
...
class TestJudger():
    ...
    def test_strength(self):
        dealer = Dealer(Deck.deck_52())
        dealer.shuffle()
        # board_cards = dealer.deal(4)
        board_cards = Card.from_str_list(['Qs', 'Th', 'Qc', 'Tc'])
        print(board_cards)
        print(self.judger.get_strength(dealer, board_cards, Card.from_str_list(['As', 'Ac'])))
        print(self.judger.get_strength(dealer, board_cards, Card.from_str_list(['Ks', 'Kc'])))
        print(self.judger.get_strength(dealer, board_cards, Card.from_str_list(['Qh', 'Qd'])))
        print(self.judger.get_strength(dealer, board_cards, Card.from_str_list(['Qh', 'Jd'])))