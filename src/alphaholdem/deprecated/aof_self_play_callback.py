...
from ..policy.aof.policy import RandomHeuristic, BroadwayHeuristic, AlwaysAllInHeuristic, AlwaysFoldHeuristic
from ..utils.logger import log
from rich import print_json

def create_aof_self_play_callback(win_rate_threshold: float, opponent_policies: list[str], opponent_count: int = 10):
    class SelfPlayCallback(DefaultCallbacks):
        def __init__(self):
            ...
            self.initial_policies = {
                ...
                "broadway": BroadwayHeuristic,
                "allin": AlwaysAllInHeuristic,
                "fold": AlwaysFoldHeuristic,
            }
        ...
        def on_train_result(self, *, algorithm: Algorithm, result: dict, **kwargs):
            ...
            win_rate = sum(main_reward) / len(main_reward) * 200
