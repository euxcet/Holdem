...
from ..arena.policy.ppo_range_kuhn_policy import PPORangeKuhnPolicy
from ..utils.logger import log
from ..utils.window import Window
from ..utils.counter import Counter

def create_range_kuhn_self_play_callback(
    ...
    class SelfPlayCallback(DefaultCallbacks):
        ...
        def calc_metric(self, algorithm: Algorithm, result: dict):
            ...
            mean, var = self.arena.ppo_vs_cfr(
                ppo=PPORangeKuhnPolicy(model=algorithm.get_policy('learned').model),
        ...
        def get_strategy(self, algorithm: Algorithm):
            ...
            policy = PPORangeKuhnPolicy(model=algorithm.get_policy('learned').model)
