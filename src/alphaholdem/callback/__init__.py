...
from .kuhn_self_play_callback import create_kuhn_self_play_callback
...
from .range_kuhn_self_play_callback import create_range_kuhn_self_play_callback
...
def get_callback(cfg: TrainConfig):
    ...
    elif cfg.self_play.type == 'kuhn':
        return create_kuhn_self_play_callback(
            cfr_strategy_checkpoint=cfg.policy.kuhn_cfr,
            opponent_policies=cfg.self_play.opponent_policies,
            num_opponent_limit=cfg.self_play.num_opponent_limit,
            num_update_iter=cfg.self_play.num_update_iter,
            payoff_max=cfg.game.payoff_max,
    ...
    elif cfg.self_play.type == 'kuhn_k_best':
        return create_kuhn_k_best_callback(
            cfr_strategy_checkpoint=cfg.policy.kuhn_cfr,
            opponent_policies=cfg.self_play.opponent_policies,
            num_opponent_limit=cfg.self_play.num_opponent_limit,
            num_update_iter=cfg.self_play.num_update_iter,
    ...
    elif cfg.self_play.type == 'range_kuhn':
        return create_range_kuhn_self_play_callback(
            cfr_strategy_checkpoint=cfg.policy.kuhn_cfr,
            opponent_policies=cfg.self_play.opponent_policies,
            num_opponent_limit=cfg.self_play.num_opponent_limit,
            num_update_iter=cfg.self_play.num_update_iter,
