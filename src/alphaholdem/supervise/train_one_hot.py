...
from ..model.hunl_supervise_one_hot import HUNLSuperviseOneHot
...
def train():
    ...
    # model = nn.DataParallel(HUNLSuperviseOneHot()).to('cuda')
    model = HUNLSuperviseOneHot()
    model.load_state_dict(torch.load('./checkpoint/supervise/one_hot_v1/supervise.pt'))
    ...
    # print(dataset[0])
    # exit(0)
    save_dir = './checkpoint/supervise/one_hot_v2/'
