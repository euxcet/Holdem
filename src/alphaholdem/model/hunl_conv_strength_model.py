...
class HUNLConvStrengthModel(TorchModelV2, nn.Module):
    def __init__(self, obs_space, act_space, num_outputs, *args, **kwargs):
        ...
        self.policy_fn = nn.Sequential(
            nn.Linear(256 + num_outputs + 1, 128),
            nn.ReLU(),
            nn.Linear(128, 64),
            nn.ReLU(),
    ...
    def forward(self, input_dict, state, seq_lens):
        ...
        out = torch.cat((card_out, action_out, input_dict['obs']['action_mask'], input_dict['obs']['strength']), dim=1)
